...
//           else ActivityCompat.requestPermissions(this, arrayOf(android.Manifest.permission.WRITE_EXTERNAL_STORAGE), 13)
    ...
    override fun onCreateOptionsMenu(menu: Menu?): Boolean {
        menuInflater.inflate(R.menu.nav_menu, menu) // Make sure yeh sahi menu file hai
        val searchItem = menu?.findItem(R.id.search_View)
        val searchView = searchItem?.actionView as? SearchView

        // Debugging logs
        Log.d("MainActivity", "SearchItem: $searchItem")
        Log.d("MainActivity", "SearchView: $searchView")
